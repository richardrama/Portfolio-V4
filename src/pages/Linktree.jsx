    ...
    return (
        <div className="bg-black flex flex-col items-center font-poppins">
            ...
            <div className={`${styles.boxWidth} py-[20px] sm:py-[20px]`}>
                <h1 className='text-[25px] sm:text-[35px] font-[700] text-white'>LinkTree</h1>
            </div>
                ...
                <div className="mt-[0px]">
                    <div class="border-l-4 border-cyan-400 bg-lightGray p-4 text-sm color-cyan">
                        <div class="flex">
                            ...
                            <div class="ml-3 text-cyan-400">LinkTree hasn't been uploaded yet. Be patient, will be back in a moment.</div>
                        </div>
                    </div>
                </div>
            </div>
